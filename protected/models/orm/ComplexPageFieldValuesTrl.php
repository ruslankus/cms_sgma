...
/**
 * This is the model class for table "complex_page_field_values_trl".
 *
 * The followings are the available columns in table 'complex_page_field_values_trl':
 * @property integer $id
 ...
 */
class ComplexPageFieldValuesTrl extends CActiveRecord
{
	/**
	...
	{
		return 'complex_page_field_values_trl';
	}
	 ...
	 * @return ComplexPageFieldValuesTrl the static model class
	 */
