 ...
 * @property Labels $translation
 * @property Languages $lng
 */
class AdminLabelsTrl extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'translation' => array(self::BELONGS_TO, 'AdminLabels', 'translation_id'),
	 ...
	 * @return AdminLabelsTrl the static model class
	 */
