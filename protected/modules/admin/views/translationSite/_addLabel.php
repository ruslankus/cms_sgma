<form method="post" action="/<?php echo $lang_prefix ?>/admin/TranslationSite/AddAdminLabel" >
<input type="hidden" name="sel_lng" value="<?php echo $sel_lng; ?>">
<input type="text" value="" id="label-popup" name="label_name" placeholder="<?php echo ATrl::t()->getLabel('label name');?>"/>
