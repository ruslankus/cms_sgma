...
<input type="text" value="" id="label-popup" name="label_name" placeholder="<?php echo Trl::t()->getLabel('language name');?>"/>
<span class="errorMessage add-lang-name-err"><?php echo $error; ?></span>
<input type="text" value="" id="label-popup" name="label_prefix" placeholder="<?php echo Trl::t()->getLabel('language prefix');?>"/>
