...
<main>
    ...
    <div class="content page-content">
        <div class="header">
            ...
            <a href="<?php echo Yii::app()->createUrl('admin/news/edititemtrl',array('id' => $item->id)); ?>" class="active"><?php echo ATrl::t()->getLabel('Content'); ?></a>
            <a href="<?php echo Yii::app()->createUrl('admin/news/edit',array('id' => $item->id)); ?>"><?php echo ATrl::t()->getLabel('Settings'); ?></a>
        </div><!--/header-->
        <form method="post" action="<?php echo Yii::app()->createUrl('admin/news/edititemtrl',array('id' => $item->id)); ?>" class="main-form-trl">
            <div class="inner-top">
                <select name="language" id="styled-language-editor" class="float-left">
                    <?php foreach($languages as $language): ?>
                    <option value="<?php echo Yii::app()->createUrl('admin/news/edititemtrl',array('id' => $item->id, 'lng' => $language->id)); ?>"><?php echo $language->name; ?></option>
                    <?php endforeach; ?>
                </select>
