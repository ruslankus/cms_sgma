...
<main>
    ...
    <div class="content page-content">
        <div class="header">
            ...
            <a href="<?php echo Yii::app()->createUrl('admin/news/edititemtrl',array('id' => $item->id)); ?>"><?php echo ATrl::t()->getLabel('Content'); ?></a>
            <a href="<?php echo Yii::app()->createUrl('admin/news/edit',array('id' => $item->id)); ?>" class="active"><?php echo ATrl::t()->getLabel('Settings'); ?></a>
        </div><!--/header-->
