            ...
            <?php foreach($item as $children): ?>
                <?php if(!$children->hasParent()): ?>
                    <div class="row root" data-id="<?php echo $children->id; ?>">
                        <div class="name"><a href="<?php echo Yii::app()->createUrl('admin/products/list',array('cat' => $children->id)); ?>"><?php echo $children->label; ?></a></div>
                ...
                <?php else: ?>
                    <div class="row" data-id="<?php echo $children->id; ?>" data-parent="<?php echo $children->parent_id; ?>">
                        <div class="name"><a href="<?php echo Yii::app()->createUrl('admin/products/list',array('cat' => $children->id)); ?>"><?php echo $children->label; ?></a></div>
                        <div class="sequen">
                            <a href="<?php echo Yii::app()->createUrl('admin/products/move',array('id' => $children->id,'dir' => 'up')); ?>" class="go-up move-item"><span class="ficoned arrow-up"></span></a>
                            <a href="<?php echo Yii::app()->createUrl('admin/products/move',array('id' => $children->id,'dir' => 'down')); ?>" class="go-down move-item"><span class="ficoned arrow-down"></span></a>
                        </div><!--/sequen-->
                        <div class="type"><?php echo $children->countOfItems(); ?></div>
                        <div class="action">
                            <a href="<?php echo Yii::app()->createUrl('admin/products/editcat',array('id' => $children->id)); ?>" class="edit"><span class="ficoned pencil"></span></a>
