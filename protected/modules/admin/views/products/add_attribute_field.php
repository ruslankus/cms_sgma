            ...
            <?php $form=$this->beginWidget('CActiveForm', array('id' =>'add-field-form','enableAjaxValidation'=>true,'htmlOptions'=>array(),'clientOptions' => array('validateOnSubmit'=>true))); ?>
                ...
                <table>
                    ...
                    <tr class="addable">
                        ...
                        <td class="value"><?php echo $form->dropDownList($form_mdl,'type_id',$types,array('data-show_variants_for' => ExtProductFieldTypes::TYPE_SELECTABLE, 'data-open_on' => ExtProductFieldTypes::TYPE_IMAGES, 'data-open_id' => 'img-sizes')); ?></td>
