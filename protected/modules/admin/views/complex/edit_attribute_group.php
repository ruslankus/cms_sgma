...
<?php /* @var $group ExtComplexPageFieldGroups */ ?>
...
<main>
    <div class="title-bar world">
        ...
        <ul class="actions">
            <li><a href="<?php echo Yii::app()->createUrl('admin/products/attrgroups') ?>" class="action undo"></a></li>
        </ul>
    </div><!--/title-bar-->
            ...
            <?php $form=$this->beginWidget('CActiveForm', array('id' =>'add-group-form','enableAjaxValidation'=>true,'htmlOptions'=>array(),'clientOptions' => array('validateOnSubmit'=>true))); ?>
                <div class="tabs">
                    ...
                    <table data-tab="<?php echo $language->prefix; ?>" <?php if($index == 0): ?> class="active" <?php endif; ?>>
                        <tr>
                            ...
                            <td class="value"><input type="text" name="AttrGroupForm[names][<?php echo $language->id; ?>]" placeholder="<?php echo ATrl::t()->getLabel('Your name'); ?>" value="<?php echo $group->getOrCreateTrl($language->id)->name; ?>" /></td>
                        </tr>
                        <tr>
                            <td class="label"><?php echo ATrl::t()->getLabel('Description'); ?> [<?php echo $language->prefix; ?>]:</td>
                            <td class="value">
                                <textarea class="text-input-in-form" placeholder="<?php echo ATrl::t()->getLabel('Your description'); ?>" name="AttrGroupForm[descriptions][<?php echo $language->id; ?>]"><?php echo $group->getOrCreateTrl($language->id)->description; ?></textarea>
                            </td>
                        </tr>
                    </table>
                    <?php endforeach; ?>
                ...
                <table>
                    <tr>
                        ...
                        <td class="value"><?php echo $form->textField($form_mdl,'label',array('placeholder' => ATrl::t()->getLabel('label'), 'value' => $group->label)); ?></td>
                    </tr>
                    <tr>
                        <td class="label">&nbsp;</td>
                        <td class="value">
