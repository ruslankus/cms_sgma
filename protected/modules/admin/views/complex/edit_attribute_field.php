            ...
            <?php $form=$this->beginWidget('CActiveForm', array('id' =>'edit-field-form','enableAjaxValidation'=>true,'htmlOptions'=>array(),'clientOptions' => array('validateOnSubmit'=>true))); ?>
                ...
                <table>
                    ...
                    <tr class="addable">
                        ...
                        <td class="value"><?php echo $form->dropDownList($form_mdl,'type_id',$types,array('data-show_variants_for' => ExtComplexPageFieldTypes::TYPE_SELECTABLE, 'data-open_on' => ExtComplexPageFieldTypes::TYPE_IMAGES, 'data-open_id' => 'img-sizes', 'options' => array($field->type_id => array('selected' => true)))); ?></td>
                        <td class="value hidden-selector" <?php echo $field->type_id != ExtComplexPageFieldTypes::TYPE_SELECTABLE ? "style='visibility: hidden'" : ''; ?>>
                            <div class="field-in-addable">
                                <?php if($field->type_id == ExtComplexPageFieldTypes::TYPE_SELECTABLE): ?>
                                    <?php foreach($field->complexPageFieldSelectOptions as $index => $variant): ?>
                    ...
                    <tr <?php if($field->type_id != ExtComplexPageFieldTypes::TYPE_IMAGES): ?> style="display: none" <?php endif; ?> id="img-sizes">
                    ...
                    <tr>
                        ...
                        <td class="value hidden-selector" <?php echo $field->type_id != ExtComplexPageFieldTypes::TYPE_SELECTABLE ? "style='visibility: hidden'" : ''; ?>>
                            <input data-count="<?php echo $field->type_id == ExtComplexPageFieldTypes::TYPE_SELECTABLE ? count($field->complexPageFieldSelectOptions) : 0; ?>" data-ploname="<?php echo ATrl::t()->getLabel('Name'); ?>" data-ploval="<?php echo ATrl::t()->getLabel('Value'); ?>" data-delname="<?php echo ATrl::t()->getLabel('Delete'); ?>" data-oname="AttrFieldForm[variants][option_name]" data-oval="AttrFieldForm[variants][option_value]" class="add-select-option-button" type="submit" value="<?php echo ATrl::t()->getLabel('Add field'); ?>">
                        </td>
                    </tr>
