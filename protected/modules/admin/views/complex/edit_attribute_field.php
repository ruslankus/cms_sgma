            ...
            <?php $form=$this->beginWidget('CActiveForm', array('id' =>'edit-field-form','enableAjaxValidation'=>true,'htmlOptions'=>array(),'clientOptions' => array('validateOnSubmit'=>true))); ?>
                ...
                <table>
                    ...
                    <tr class="addable">
                        ...
                        <td class="value"><?php echo $form->dropDownList($form_mdl,'type_id',$types,array('data-show_variants_for' => ExtComplexPageFieldTypes::TYPE_SELECTABLE, 'options' => array($field->type_id => array('selected' => true)))); ?></td>
