...
<main>
    ...
    <div class="content widget-content">
        ...
        <div class="tab-line">
            <span><a href="<?php echo Yii::app()->createUrl('admin/settings/index') ?>"><?php echo ATrl::t()->getLabel('Templates'); ?></a></span>
            ...
            <span><a href="<?php echo Yii::app()->createUrl('admin/settings/general') ?>"><?php echo ATrl::t()->getLabel('General settings'); ?></a></span>
        </div><!--/tab-line-->
