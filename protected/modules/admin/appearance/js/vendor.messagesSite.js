(function( $ ){
	...
	*/
	...
	$("#styled-language").on("change", function(){
		...
		var link = '/'+ prefix +'/admin/TranslationSite/AdminMessagesAjax';
	...
	*/ 
	$('.add-label').click(function(e)
	{
		...
		var link = '/'+ prefix +'/admin/TranslationSite/AddAdminMessageAjax';
	 ...
	 $(document).on('click','.add-label-popup',function(e){
	     ...
	     var link = '/'+ prefix +'/admin/TranslationSite/UniqueCeckAdminMessageAjax';
	...
	*/
	$(document).on("click",".delete",function(e)
	{
		...
		var link = '/'+ prefix +'/admin/TranslationSite/DelAdminMessageAjax';
	...
	*/
	$(document).on("click",".save",function(e)
	{
		...
		var link = '/'+ prefix +'/admin/TranslationSite/SaveAdminMessageAjax/'+id;
