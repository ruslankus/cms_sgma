(function( $ ){
	...
	*/ 
	$('.add-label').click(function(e)
	{
		...
		var link = '/'+ prefix +'/admin/TranslationSite/AddAdminLabelAjax';
	 ...
	 $(document).on('click','.add-label-popup',function(e){
	     ...
	     var link = '/'+ prefix +'/admin/TranslationSite/UniqueCeckAdminLabelAjax';
	...
	*/
	$(document).on("click",".delete",function(e)
	{
		...
		var link = '/'+ prefix +'/admin/TranslationSite/DelAdminLabelAjax';
	...
	*/
	$(document).on("click",".save",function(e)
	{
		...
		var link = '/'+ prefix +'/admin/TranslationSite/SaveAdminLabelAjax/'+id;
